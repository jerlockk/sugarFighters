...
voice.addEventListener('click', function () {
    if (isRecognizing) {
        recognition.stop();
        voice.innerHTML = 'Grabar<i class="material-icons right">send</i>';
    } else {  
        finalTranscript = '';
        recognition.start();
        voice.innerHTML = 'Enviar<i class="material-icons right">send</i>';
    }
}); 
...
recognition.onend = function() {
    ...
    // Send the user message
    Api.sendRequest(finalTranscript, context);
    textInput.value = '';
};
