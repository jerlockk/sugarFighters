...
app.get('/api/recognition/:id', function (req, res) {
    const { id } = req.params;
    var result;
    var fs = require('fs');
    var visualRecognition = new watson.VisualRecognitionV3({
        iam_apikey: '6ewvVL6laHOnChWVaGoR8FWKu4bjmu0Lm24JPOUcN8xx',
        version_date: '2018-06-20'
    });
    var url = 'public/img/food/'+id+'.jpg';
    var images_file = fs.createReadStream(url);
    var classifier_ids = ['FoodC_782451963'];
    var threshold = 0.06;
